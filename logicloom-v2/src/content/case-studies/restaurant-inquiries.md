...
<div class="not-prose mt-8 mb-8 p-6 bg-slate-100 rounded-2xl border-l-4 border-slate-900">
  <ul class="space-y-2 text-slate-700 font-medium">
    <li><strong>🔴 The Problem:</strong> General Manager was replying to catering leads 48 hours late.</li>
    <li><strong>🛠 The Fix:</strong> An OpenAI webhook that reads emails & checks calendar availability.</li>
    <li><strong>🟢 The Result:</strong> Response time cut to 45s; $12k/mo in lost revenue recovered.</li>
  </ul>
</div>
...
<div class="my-8 p-4 bg-blue-50 text-blue-900 rounded-xl text-sm font-semibold flex items-center gap-3">
  ...
  <a href="/audit?context=ServiceConcierge" class="underline hover:text-blue-700">Audit your Booking Flow →</a>
</div>
...
<div class="mt-12 text-center">
  <p class="text-slate-400 text-sm">Need help with member retention?</p>
  <a href="/case-studies/fitness-trainers" class="text-slate-600 font-semibold hover:text-slate-900">See how we automated Churn Reduction →</a>
</div>